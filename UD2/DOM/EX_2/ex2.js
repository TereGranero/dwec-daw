window.onload = function() {
    ...
    */
    function color_menu(menu_to_change) {
        menu_to_change.forEach((item) => {
            ...
            item.innerHTML = `<span style="color: red;">${text}</span>`;
        });
    }
    ...
    */
    ...
    content_div.innerHTML = '<p>Primer paragraf</p><p>Segon paragraf</p><p>Tercer paragraf</p>'
}